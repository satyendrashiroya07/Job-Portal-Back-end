...
<%@ page import="com.shiroya.Findjob.model.JobPost" %>
<%@ page import="com.shiroya.Findjob.repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<nav class="navbar navbar-expand navbar-light bg-warning">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">Shiroya Job Portal Web App</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item"><a class="nav-link" href="home"><h3>Home</h3></a></li>
                <li class="nav-item"><a class="nav-link" href="viewalljobs"><h3>All Jobs</h3></a></li>
                <li class="nav-item"><a class="nav-link" href="https://www.linkedin.com/in/satyendrachaurasiya//"><h3>Contact</h3></a></li>
            </ul>
        </div>
    </div>
</nav>
